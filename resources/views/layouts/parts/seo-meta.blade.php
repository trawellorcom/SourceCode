@if(!empty($seo_meta))
    ...
    @endif
    <title>{{ $seo_meta['seo_title'] ?? $seo_meta['service_title'] ?? $page_title ?? ""}} - {{setting_item_with_lang('site_title' ,false,'Booking Core')}}</title>
...
@else
    <title>{{ $page_title ?? ''}} - {{setting_item_with_lang('site_title' ,false,'Booking Core')}}</title>
