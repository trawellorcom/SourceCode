            ...
            <div class="panel">
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <label><input type="checkbox" name="space_enable_review" value="1" @if(!empty($settings['space_enable_review'])) checked @endif /> {{__("On Review")}} </label>
                            <br>
                    ...
                    <div class="form-group" data-condition="space_enable_review:is(1)">
                        ...
                        <div class="form-controls">
                            <label><input type="checkbox" name="space_enable_review_after_booking" value="1"  @if(!empty($settings['space_enable_review_after_booking'])) checked @endif /> {{__("On")}} </label>
                            <br>
                    ...
                    <div class="form-group" data-condition="space_enable_review:is(1)">
                        ...
                        <div class="form-controls">
                            <label><input type="checkbox" name="space_review_approved" value="1"  @if(!empty($settings['space_review_approved'])) checked @endif /> {{__("On approved")}} </label>
                            <br>
