...
use Modules\Tour\Providers\RouterServiceProvider;
...
class ModuleProvider extends ModuleServiceProvider
{
    ...
    {
        $this->mergeConfigFrom(__DIR__ . '/Config/config.php', 'tour');
        ...
        return [
            'tour' => [
                ...
                'children'   => [
                    ...
                    [
                        'url'        => app_get_locale() . '/user/tour/create',
                        'title'      => "Add Tour",
                        'permission' => 'tour_create',
                    ],
                    [
                    ...
                    [
                        'url'        => app_get_locale() . '/user/tour/booking-report',
